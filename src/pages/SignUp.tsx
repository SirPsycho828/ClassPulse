        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-primary-foreground">
          ...
          <div>
            ...
            <p className="mt-4 text-primary-foreground/70 max-w-md leading-relaxed">
              Join teachers who save hours each week with AI-powered classroom analysis and personalized intervention plans.
            </p>
          </div>
          <p className="text-primary-foreground/40 text-sm">Free to start. No credit card required.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-4 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1 text-sm">Create your teacher account</p>
          </div>

          <div className="hidden lg:block mb-8">
            <h1 className="font-heading text-3xl font-bold text-foreground">Create your account</h1>
            <p className="text-muted-foreground mt-1">Get started with free classroom analysis</p>
          </div>
          ...
          <div className="bg-card rounded-[--radius-lg] shadow-[--shadow-sm] border border-border p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-xs font-medium text-muted-foreground mb-1.5 tracking-wide uppercase">Name</label>
                <input
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link to="/sign-in" className="text-accent hover:text-accent/80 font-medium transition-colors">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
